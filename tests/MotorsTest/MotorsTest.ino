...
class Test {
  public:
    Test(void) : _completed(false), _valid(false) {}
...
static Test * tests[] {
  new MotorPowerTest("1. Test left motor power", leftMotor, MAX_POWER / 2),
  new MotorPowerTest("2. Test right motor power", rightMotor, MAX_POWER / 2),
  new SpeedTest("3. Test left speed forward", TEST_SPEED, 0),
  new SpeedTest("4. Test left speed backward", -TEST_SPEED, 0),
  new SpeedTest("5. Test right speed forward", 0, TEST_SPEED),
  new SpeedTest("6. Test right speed backward", 0, -TEST_SPEED),
  new SummaryTest(),
  new SensorsTest()
};
